...
import com.hacktiv8.buxfinalproject3.databinding.ActivityCreditCardVerificationBinding;
        ...
        db.collection("user")
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        Intent intent = new Intent(CreditCardVerificationActivity.this, HomePageActivity.class);
